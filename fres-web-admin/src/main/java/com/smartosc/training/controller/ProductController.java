...
public class ProductController {
    ...
    public String getListAllProductBySearchValue(Model model,
                                                 @RequestParam(defaultValue = "", required = false) String searchValue,
                                                 @RequestParam(defaultValue = "0", required = false) Integer pageNo,
                                                 @RequestParam(defaultValue = "20", required = false) Integer pageSize,
                                                 @RequestParam(defaultValue = "productId", required = false) String sortBy) throws UnsupportedEncodingException {
